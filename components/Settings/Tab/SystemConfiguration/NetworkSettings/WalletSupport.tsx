...
const rpcOptions: RPCOption[] = [
  { code: "metamask", label: "MetaMask" },
  { code: "trustwallet", label: "Trust Wallet" },
  { code: "ledger", label: "Ledger" },
];

export default function WalletSupport({ onBack }: Props) {
  const [selected, setSelected] = useState<string>("metamask");
