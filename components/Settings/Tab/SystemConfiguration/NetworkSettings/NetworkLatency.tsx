...
const rpcOptions: RPCOption[] = [
  { code: "250ms", label: "250ms" },
  { code: "500ms", label: "500ms" },
  { code: "800ms", label: "800ms" },
];

export default function NetworkLatency({ onBack }: Props) {
  const [selected, setSelected] = useState<string>("250ms");
