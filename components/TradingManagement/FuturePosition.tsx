            ...
            orders.map((order, index) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-3 py-4">${Number(order.entryPrice || 0).toFixed(4)}</td>
                  <td className="px-3 py-4">${Number(currentPrice || 0).toFixed(4)}</td>
                  
                  <td className="px-3 py-4 flex flex-col gap-1 text-xs font-Manrope">
                    <span className={pnlUp ? "text-green-500" : "text-red-500"}>
                      {pnlUp ? "+" : ""}{Number(computedPnl || 0).toFixed(2)} USDT
                    </span>
                    <div className="flex items-center gap-1">
                      ...
                      <span className={pnlUp ? "text-green-500" : "text-red-500"}>
                        {Number(computedPnlPercent || 0).toFixed(2)}%
                      </span>
                    </div>
                  </td>
